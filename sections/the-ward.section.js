  ...
  <div id="ward-app" style="display:none;flex-direction:column;flex:1;">
    ...
    <div class="ward-top-info-bar">
      ...
      <div class="ward-room-quick-btns">
        ...
        <button class="ward-room-quick-btn ward-rqb-join"   id="ward-topbar-join-btn"   onclick="wardQuickJoinRoom()">🔑 Join Study Together room</button>
      ...
      <div class="ward-timer-hero">
        ...
        <div style="width:100%;max-width:660px;display:flex;flex-direction:column;align-items:center;gap:0.6rem;">
          ...
          <div class="ward-today-strip">
            <div class="ward-today-stat" style="align-items:flex-start;text-align:left;"><span class="ward-today-num" id="ward-today-sessions" style="font-size:0.78rem;line-height:1.15;letter-spacing:0.02em;color:#ffd966;">1.2× points</span><span class="ward-today-lbl" style="text-transform:none;letter-spacing:0.02em;font-size:0.58rem;opacity:0.6;">if studying together</span></div>
        ...
        <div class="ward-panel-content">
          ...
          <div class="ward-panel-section" id="ward-section-squad">
            <div id="ward-squad-lobby">
              ...
              <input class="ward-field-input" id="ward-squad-join-input" placeholder="Study Together room code e.g. TIBIA-42" maxlength="12" style="text-transform:uppercase;margin-bottom:0.45rem;"/>
              <button class="ward-auth-submit" style="background:linear-gradient(135deg,rgba(255,192,0,0.18),rgba(255,192,0,0.09));border-color:rgba(255,192,0,0.28);color:#ffd966;font-size:0.82rem;padding:0.6rem;" onclick="wardJoinRoom()">🔑 Join Study Together Room</button>
...
<!-- ══════════════════════ /THE WARD ══════════════════════════ -->
`;
  const scriptTag = document.currentScript || Array.from(document.scripts || []).find(s => /the-ward\.section\.js$/.test(s.src || ''));
